...
public class QRCodeFragment extends DialogFragment implements OnLoadingListener {

    Bitmap mBitmap;
    ImageView imageView;
    public static QRCodeFragment getInstance(String msg){
        QRCodeFragment secondFragment= new QRCodeFragment();
